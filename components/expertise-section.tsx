        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <motion.div variants={itemVariants} className="lg:col-span-4">
              <div
                ref={zeroOneRef}
                className="text-[120px] sm:text-[180px] font-bold leading-none text-webelio-secondary relative"
              >
                0-
                {showOne ? (
                  <motion.span
            ...
            <motion.div variants={itemVariants} className="lg:col-span-8 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-webelio-secondary text-sm">Trusted by global enterprises since 2019</p>
                <div className="flex text-webelio-secondary">
                  <span>★★★★★</span>
                </div>
              </div>

              <h3 className="text-3xl sm:text-4xl font-bold leading-tight">
                We help businesses grow with innovative IT solutions that are scalable, future-ready, and built to make
                a lasting impact.
              </h3>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Card 2: Enhanced 95% stat with viewport trigger */}
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-webelio-secondary/50 transition-all duration-300 relative overflow-hidden">
                <div className="absolute top-6 right-6">
                  <ArrowUpRight className="w-5 h-5 text-muted-foreground group-hover:text-webelio-secondary transition-colors" />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <Star className="w-4 h-4 text-webelio-secondary" />
                    </motion.div>
                  </div>

                  <ViewportTriggered95Percent />

                  <p className="text-muted-foreground">of clients recommend us to other businesses</p>

                  {/* Enhanced testimonial section */}
                  <div className="pt-2 pb-4">
                    <div className="flex items-start space-x-2">
                      <ThumbsUp className="w-4 h-4 text-webelio-secondary mt-1 flex-shrink-0" />
                      <p className="text-xs text-muted-foreground italic">
                        "Their expertise in mobile development and AI solutions transformed our digital presence
                        completely."
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    <motion.div
                      ...
                      className="px-3 py-1.5 bg-gradient-to-r from-webelio-secondary/10 to-webelio-secondary/5 border border-webelio-secondary/20 rounded-full text-webelio-secondary text-xs flex items-center space-x-1 shadow-sm hover:shadow-md transition-shadow"
                    >
                    ...
                    <motion.div
                      ...
                      className="px-3 py-1.5 bg-gradient-to-r from-webelio-tertiary/10 to-webelio-tertiary/5 border border-webelio-tertiary/20 rounded-full text-webelio-tertiary text-xs flex items-center space-x-1 shadow-sm hover:shadow-md transition-shadow"
                    >
                    ...
                    <motion.div
                      ...
                      className="px-3 py-1.5 bg-gradient-to-r from-webelio-accent/10 to-webelio-accent/5 border border-webelio-accent/20 rounded-full text-webelio-accent text-xs flex items-center space-x-1 shadow-sm hover:shadow-md transition-shadow"
                    >
            ...
            {/* Card 3: ChargePe with working video */}
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-border bg-background/50 overflow-hidden hover:border-webelio-secondary/50 transition-all duration-300 relative">
                <div className="absolute top-6 right-6 z-10">
                  <ArrowUpRight className="w-5 h-5 text-white group-hover:text-webelio-secondary transition-colors" />
                </div>
                ...
                <div className="relative z-10 p-6 h-full flex flex-col justify-between">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold text-white">
                      10K+ EV Chargers: Our flagship product revolutionizing electric mobility in India
                    </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-webelio-secondary/50 transition-all duration-300">
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h3 className="text-2xl font-bold">A streamlined process, executed with methodical care.</h3>
                    <p className="text-muted-foreground">
                      We transform complex business challenges into innovative digital solutions, built to reflect
                      quality, scalability, and excellence
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm">Mobile App & Backend for Reliance Jio</p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">Value generated by the brands we've partnered with</p>
                    </div>
                    <div className="flex items-center space-x-2 px-3 py-2 bg-background/50 backdrop-blur-sm border border-border/30 rounded-full self-start lg:self-center">
                      ...
                      <span className="text-xs font-bold text-webelio-secondary">Webelio</span>
                    </div>
                  </div>
...
function ViewportTriggered95Percent(): ReactElement {
  const ref = useRef(null)
    ...
    <div ref={ref} className="relative">
      ...
      <div className="flex flex-wrap gap-4 mt-2">
        <div className="flex items-center space-x-1">
          <CheckCircle className="w-4 h-4 text-webelio-secondary" />
          <span className="text-sm">Verified</span>
        </div>
        <div className="flex items-center space-x-1">
          <Rocket className="w-4 h-4 text-webelio-secondary" />
      ...
      <motion.div
        className="absolute -top-2 -right-2 w-3 h-3 bg-webelio-secondary rounded-full"
        animate={{
          scale: [1, 1.5, 1],
          opacity: [0.5, 1, 0.5],
        }}
...
function AnimatedTimelineChart(): ReactElement {
  ...
  const stages = [
    { name: "Discovery", duration: "1 Week", position: 20, color: "#FFCC66" },
    { name: "Design", duration: "2 Weeks", position: 50, color: "#FFCC66" },
    { name: "Development", duration: "4 Weeks", position: 80, color: "#FFCC66" },
  ]
  ...
  return (
    <div className="relative h-32 bg-gradient-to-r from-muted/10 to-muted/5 rounded-lg p-4">
      ...
      <motion.div
        className="absolute top-1/2 left-4 h-1 bg-webelio-secondary rounded-full"
        ...
        >
          ...
          <motion.div
            className={`w-5 h-5 rounded-full border-2 border-background relative z-10 transition-colors duration-500 ${
              index <= activeStage ? "bg-webelio-secondary" : "bg-muted/50"
            }`}
          ...
          <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 text-center">
            <motion.div
              className={`px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap transition-colors duration-500 ${
                index <= activeStage ? "bg-webelio-secondary text-webelio-primary" : "bg-muted/50 text-muted-foreground"
              }`}
            >
              {stage.name}
            </motion.div>
    ...
    <div className="relative h-16 overflow-hidden">
      ...
      >
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Reliance Jio</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">BP Wings Biotech</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Brahma Kumaris</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">The Fuel Delivery</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Galler</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Droom</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">SportSanta</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Fortis Hospital</span>
        </div>
      ...
      >
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Webelio</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">ChargePe</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Codeless App Builder</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Sangeeta S Bahl</span>
        </div>
        <div className="h-5 w-auto">
          <span className="text-xs font-bold text-webelio-secondary opacity-70">Galler</span>
        </div>
...
function ServiceSelectionCard(): ReactElement {
  ...
  const services = [
    ...
    },
    {
      ...
      color: "from-webelio-tertiary to-webelio-tertiary",
      hoverColor: "from-webelio-tertiary/80 to-webelio-tertiary/80",
      borderColor: "border-webelio-tertiary/30",
      textColor: "text-webelio-tertiary",
    },
    {
      id: "iot",
      name: "IoT Solutions",
    ...
    },
    {
      ...
      color: "from-webelio-accent to-webelio-accent",
      hoverColor: "from-webelio-accent/80 to-webelio-accent/80",
      borderColor: "border-webelio-accent/30",
      textColor: "text-webelio-accent",
    },
    {
      id: "uiux",
      name: "UI/UX Design",
  ...
  const questions = [
    ...
    },
    {
      ...
      options: ["₹50K-₹2L", "₹2L-₹10L", "₹10L-₹50L", "₹50L+"],
    },
    {
      id: "timeline",
    ...
    return (
      <div className="h-full rounded-lg border border-border bg-black text-white p-6 flex flex-col justify-center items-center">
        <div className="text-center space-y-4">
          <div className="w-16 h-16 bg-webelio-tertiary/20 rounded-full flex items-center justify-center mx-auto">
            <div className="w-8 h-8 bg-webelio-tertiary rounded-full" />
          </div>
          ...
          <div className="pt-4">
            <button
              ...
              className="px-4 py-2 bg-webelio-tertiary text-webelio-primary rounded-lg hover:bg-webelio-tertiary/80 transition-colors text-sm font-medium"
            >
